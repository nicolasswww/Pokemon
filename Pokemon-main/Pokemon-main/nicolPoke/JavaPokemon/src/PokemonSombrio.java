public class PokemonSombrio extends Pokemon {

    public PokemonSombrio(String nome, String tipo, int hp, int ataque) {
    ...
    public void receberDano(int quantidadeDano, Pokemon oponente) {
        if ((oponente.getTipo() == "Fantasma") || (oponente.getTipo() == "Psíquico")) {
            this.hp -= quantidadeDano / 2;
        }
        else if ((oponente.getTipo() == "Fada") || (oponente.getTipo() == "Lutador") 
             || (oponente.getTipo() == "Inseto")) {
            this.hp -= quantidadeDano * 2;
        }
        if (this.hp <= 0) {
            this.hp = 0;
